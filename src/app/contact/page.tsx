              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 px-6 py-4 bg-gold hover:bg-gold/90 text-charcoal font-medium rounded-md shadow-sm hover:shadow-md transition-all duration-200"
                  >
