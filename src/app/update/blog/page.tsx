    ...
    <div className="min-h-screen bg-[#F5F5F5] p-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <h1 className="text-4xl font-display mb-2">Manage Blog Posts</h1>
        </header>
        ...
        <div className="bg-pure-white p-12 shadow-sm text-center">
          ...
          <p className="text-charcoal/70 mb-6 max-w-2xl mx-auto">
            Blog post management (writing, video, audio) is handled through
            Sanity Studio with a rich text editor and media upload capabilities.
          </p>
          <Link
            href="/studio"
