    ...
    <div className="min-h-screen bg-[#F5F5F5] p-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <h1 className="text-4xl font-display mb-2">Manage Projects</h1>
        </header>
        ...
        <div className="bg-pure-white p-12 shadow-sm text-center">
          ...
          <p className="text-charcoal/70 mb-6 max-w-2xl mx-auto">
            Project management is handled directly through Sanity Studio for the
            best content management experience. You can add, edit, and manage
